    ...
    switch (activeScreen) {
      ...
      case "ResetPin":
        ...
        return (
          ...
          >
            <Text style={{ fontSize: 20, color: CoffeeColors.DARK_BROWN }}>
      ...
      case "Fermenting":
        // Placeholder Fermenting screen
        return <FermentingScreen onNavigate={handleNavigate} />;

      case "Washing":
        return <WashingScreen onNavigate={handleNavigate} />;

      case "Drying":
        return <DryingScreen onNavigate={handleNavigate} />;

      case "Bagging":
        return <BaggingScreen onNavigate={handleNavigate} />;
